...
MVPリリース時に作っていたいもの、、トップページ、ユーザー登録機能、ログイン機能３、質問に基づくマッチング機能、猫の一覧ページ閲覧機能、猫の詳細ページ閲覧機能、写真投稿機能、掲示板（猫）投稿機能、掲示板（猫）編集機能、掲示板（猫）削除機能


本リリースまでに作っていたいもの、、コミュニティ（チャット）機能、いいね機能、いいね解除機能、専門家アドバイス機能、猫の健康管理機能、位置情報表示機能（Googleマップ表示機能）、LINE通知機能、マルチ検索・オートコンプリート、レビュー（レーティング）・口コミ閲覧機能、レビュー（レーティング）・口コミ投稿機能、レビュー（レーティング）・口コミ編集機能、レビュー（レーティング）・口コミ削除機能、ソート機能、ページネーション機能、パスワード変更機能、メールアドレス変更機能、条件に合う猫検索機能
